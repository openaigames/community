# 可试玩 Demo / Playable demos

这里保存通过 PR 合入的 Demo 资料：试玩入口、署名、制作记录和版本变化。首批作品征集中。
This directory keeps demo records merged through PRs: playable links, credits, making-of notes, and version changes. First submissions are welcome.

复制 [demo.md 模板](../templates/demo.md)到 `demos/<short-name>/README.md`，填写后提交 PR。
